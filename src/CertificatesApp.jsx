    ...
    return (
        <div
            ...
            style={{
                ...
                background: hover ? 'var(--os-glass)' : 'var(--os-hover)',
                boxShadow: hover ? `0 0 0 1px ${color}, 0 10px 30px ${color}33, inset 0 0 20px ${color}11` : '0 0 0 1px var(--os-border)5)',
                overflow: "hidden",
                cursor: "pointer",
    ...
    return (
        ...
        >
            ...
            <button
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'var(--os-border)7)'; e.currentTarget.style.transform = 'scale(1)'; }}
            >
            ...
            <div style={{
                ...
                {!isMobile && (
                    <button
                        ...
                        style={{
                            background: currentIndex === 0 ? 'var(--os-border)3)' : 'var(--os-border)8)',
                            border: '1px solid rgba(255,255,255,0.12)',
                            color: currentIndex === 0 ? 'var(--os-border-active)' : 'var(--os-text)',
                            width: 44, height: 44,
                            borderRadius: '50%',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <div
                    ...
                    style={{
                        ...
                        display: 'inline-flex',
                        boxShadow: `0 0 100px -20px ${cert.color}70, 0 0 0 1px var(--os-border)8)`,
                        borderRadius: 10,
                        overflow: 'hidden',
                        background: isBlackedOut ? '#000' : 'var(--os-text)',
                        alignItems: 'center',
                        justifyContent: 'center',
                        transition: 'box-shadow 0.4s ease',
                ...
                {!isMobile && (
                    <button
                        ...
                        style={{
                            background: currentIndex === certs.length - 1 ? 'var(--os-border)3)' : 'var(--os-border)8)',
                            border: '1px solid rgba(255,255,255,0.12)',
                            color: currentIndex === certs.length - 1 ? 'var(--os-border-active)' : 'var(--os-text)',
                            width: 44, height: 44,
                            borderRadius: '50%',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                {certs.map((c, i) => (
                    <button
                        ...
                        style={{
                            ...
                            height: 8,
                            borderRadius: 4,
                            background: i === currentIndex ? cert.color : 'var(--os-border-active)',
                            border: 'none',
                            cursor: 'pointer',
                            transition: 'all 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)',
                            padding: 0
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    top: 0, left: 0, right: 0,
                    height: "100%",
                    background: "repeating-linear-gradient(0deg, transparent, transparent 2px, var(--os-border)12) 2px, var(--os-border)12) 4px)",
                    pointerEvents: "none",
                    zIndex: 0
                }} />
